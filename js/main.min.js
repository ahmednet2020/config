...
var y = exports.y = function y(txt) {
  return txt;
};
...
var sum = exports.sum = function sum(n) {
    return n;
};
var z = sum(age.mohamed);
console.log((0, _app.y)("hello"));
...
},{"core-js/fn/regexp/escape":7,"core-js/shim":330,"regenerator-runtime/runtime":6}],6:[function(require,module,exports){
(function (global){
/**
